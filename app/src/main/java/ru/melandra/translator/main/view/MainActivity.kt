package ru.melandra.translator.main.view
...
import ru.melandra.translator.R
import ru.melandra.translator.main.presenter.MainPresenter
...
import ru.melandra.translator.view.base.BaseActivity
...
class MainActivity : BaseActivity<DataModel>() {
    ...
    override fun createPresenter(): Presenter<DataModel, BaseView> {
            ...
            is DataModel.Success -> {
                ...
                if (searchResult == null || searchResult.isEmpty()) {
                    ...
                    if (adapter == null) {
                        ...
                        main_activity_recyclerview.adapter = MainRvAdapter(onListItemClickListener, searchResult)
                    } else {
